...
#ifdef MICROPY_OBJ_IMMEDIATE_OBJS
//https://github.com/pfalcon/pycopy/commit/2a362af5bcdeaadd94ddac7f90ea33092a7ac7be
#undef MICROPY_OBJ_IMMEDIATE_OBJS
...
#else
    //#pragma message "build/frozen_mpy.c:7:2: error: 'incompatible MICROPY_OPT_CACHE_MAP_LOOKUP_IN_BYTECODE'"
...
#else
    #pragma message "build/frozen_mpy.c:12:2: error: 'incompatible MICROPY_LONGINT_IMPL'"
